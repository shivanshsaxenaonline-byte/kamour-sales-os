-- Down for 031 · restores the 030 generator: a lead that merely appeared on a
-- list in the last seven days is treated as worked, and nothing is carried
-- over to the rep who did not get to it.
